...
$ cmake \
  -DCLANG_URL=https://bitbucket.org/multicoreware/kalmar-omp.git \
  ../kalmar-omp-driver/
...
*Note: You need to set all environment variables mentioned above with Kalmar-OMP Compiler and OpenMP runtime.*
